...
$(function () {
    ...
    $(document).on('click', '[data-news="container"]', function () {

        var current = $(this).find('[data-news="full-text"]');

     $('[data-news="full-text"]').each(function (i, e) {
        var elem = $(e);
         if(elem.css('display') == 'block' && current.get(0) !== elem.get(0)){
